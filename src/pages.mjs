...
pages.push(
  { path: "/vietnam/how-to-get/", kind: "route", country: "vietnam", eyebrow: "Муйне · дорога", title: "Как добраться до Ветратории в Муйне", description: "Адрес станции Sun & Sands Beach, координаты, переезд из Хошимина и подготовка к поездке со своим снаряжением.", image: "/assets/img/vietnam-source/station-seafront.webp" },
  {
...
const vietnamMeta = {
  ...
  "/vietnam/windsurf/": ["Виндсёрфинг в Муйне — обучение и прокат | Ветратория", "Уроки виндсёрфинга с нуля, курсы на 3 и 7 дней, самостоятельная практика и прокат в Муйне. Программа, оборудование и запись.", "windsurf-launch.webp"],
  ...
  "/vietnam/surf/": ["Сёрфинг в Муйне — уроки на волнах Малибу | Ветратория", "Классический сёрфинг на Малибу: индивидуальное занятие 1 час или группа 2–3 человека на 1,5 часа. Подбор волн и времени занятий.", "surf-wave.webp"],
  ...
  "/vietnam/surf/price/": ["Цены на сёрфинг в Муйне — уроки, прокат досок и SUP", "Индивидуальные и групповые уроки сёрфинга на Малибу, продолжительность занятий, прокат серфборда и SUP. Стоимость и запись в Ветратории.", "surf-wave.webp"],
  "/vietnam/team/": ["О школе и станции Ветратория в Муйне", "Ветратория в Муйне с 2011 года: обучение четырём дисциплинам, инфраструктура Sun & Sands и подбор снаряжения для поездки.", "station-seafront.webp"],
};
