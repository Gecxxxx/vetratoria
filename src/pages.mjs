...
export const site = {
  ...
  countries: [
    ...
    },
    {
      ...
      seasonNote: "В проекте подтверждён сильный зимний сезон. Доступность занятий и прогноз команда подтверждает перед поездкой.",
    ...
    },
    {
      ...
      season: "летний сезон",
      seasonTitle: "Летний сезон",
      seasonMonths: ["jun", "jul", "aug"],
      seasonNote: "В проекте подтверждён летний формат. Условия и расписание команда уточняет под конкретные даты.",
...
const pages = [
  ...
  },
  {
    ...
    description: "Вернитесь на главную или выберите направление Vetratoria.",
